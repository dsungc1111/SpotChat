...
final class EditUserView: BaseView {
    ...
    let nicknameTextField = CustomSignTextField(placeholderText: UserDefaultsManager.userNickname)
    
    let bioTextfield = CustomSignTextField(placeholderText: "상태 메시지 입력")
